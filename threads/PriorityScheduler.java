 ...
 * 
 * The additional code of this file to complete assignment 1 is not mine!! Task 5 of assignment 1
 * was completed through the use of Qinshi Wang's code which can be found in the GitHub link below:
 * https://github.com/bcip/nachos/blob/master/threads/PriorityScheduler.java
 */
public class PriorityScheduler extends Scheduler {
	...
	protected void updateDonatingPriority()
	{
		...
		{
			newDonatingPriority = waitingQueue.first().getEffectivePriority();
		}
		else
		{
			newDonatingPriority = priorityMinimum;
		...
		if(occupyingThread != null)
		{
			getThreadState(occupyingThread).prepareToUpdateDonatingPriority(this);
		}
	}
	/**
	...
	protected void updateEffectivePriority() {
		...
		if(!acquires.isEmpty())
		{
			newEffectivePriority = Math.max(priority, acquires.first().getDonatingPriority());
